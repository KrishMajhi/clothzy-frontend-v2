  ...
  return (
    <div className="view">
      <div className="profilepage-header">
        ...
        <p className="profilepage-sub">Overview of your account activity and recent orders</p>
      </div>
        ...
        <div className="profile-quick-view">
          {[
            ...
            { label: "Member Since", value: personalInfo.created_at
                ? new Date(personalInfo.created_at).toLocaleDateString("en-IN", { month: "short", year: "numeric" })
                : null },
          ].map(({ label, value }) => (
