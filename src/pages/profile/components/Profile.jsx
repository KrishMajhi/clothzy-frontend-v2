...
export default function Profile() {
  ...
  const isActive = (id) =>
    activeSection === id ||
    (id === "orders" && ["orders", "orders-list", "order-detail"].includes(activeSection));

  const renderContent = () => {
    switch (activeSection) {
      case "overview":     return <OverviewComp />;
      case "profile":      return <PersonalInfoComp />;
      case "orders":       return <OrdersComp onViewOrder={handleViewOrder} onViewAll={() => setActiveSection("orders-list")} />;
      case "orders-list":  return <OrdersListComp onViewOrder={handleViewOrder} />;
      case "order-detail": return <OrderDetailComp orderId={selectedOrderId} onBack={handleBackToOrders} />;
      case "addresses":    return <AddressComp />;
    ...
    <div className="profile-page">
      <div className="layout">
        <aside className="sidebar">
          <div className="sidebar-logo"><span>C</span>LOTHZY</div>
          ...
          <nav className="sidebar-nav">
            ...
            <div className="nav-section" style={{ marginTop: "28px" }}>Security</div>
          ...
          <div className="sidebar-user">
            <div className="sidebar-user-name">{personalInfo.fullname || "User"}</div>
